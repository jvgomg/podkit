...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 --report flag on device scan outputs diagnostic report to stdout
- [ ] #2 Report includes podkit version, OS version, platform
- [ ] #3 Report includes all readiness check results with details
- [ ] #4 File paths with usernames redacted on both macOS and Linux
- [ ] #5 Volume names preserved (not redacted)
- [ ] #6 Report is plain text suitable for pasting into GitHub issues
- [ ] #7 Unit tests for report format and redaction rules
<!-- AC:END -->
