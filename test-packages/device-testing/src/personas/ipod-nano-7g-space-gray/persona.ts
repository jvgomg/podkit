 ...
 * `@podkit/e2e-vm-tests/src/expectations/ipod-nano-7g-space-gray.ts` (schema v3).
 *
 * @see docs/test-devices.md §"iPod nano 7th Generation (16GB)"
 * @see docs/sysinfo-captures/nano-7g-16gb-usb.xml
 * @module
 */
