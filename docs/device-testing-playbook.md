...
**Update:** `docs/device-identification.md` open questions section with findings.
...
**Update:** `docs/device-identification.md` with findings.
...
**Update:** `docs/device-identification.md` and `docs/test-devices.md`.
...
Run this for each iPod in the collection. Record all results in `docs/test-devices.md`.
...
Record: success/failure, number of VPD subpages, XML byte count. Save the full XML output to `docs/sysinfo-captures/<device-name>.xml` for reference.
