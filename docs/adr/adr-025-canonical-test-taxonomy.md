...
[docs/architecture/testing/taxonomy.md](../architecture/testing/taxonomy.md).
Re-labels the "five tiers" of **doc-053 (podkit-docker testing strategy)**
and the "Tier-3" alias introduced by
[ADR-016](./adr-016-linux-vm-test-harness.md). ADR-016 is left
...
([taxonomy §8](../architecture/testing/taxonomy.md)). doc-053
...
- **Cost.** A one-time migration: move the ~8 host `*.docker.test.ts`
  ...
  docs/agents/testing.md. Existing task titles ("Test Tier N", TASK-447–451)
...
- [docs/architecture/testing/taxonomy.md](../architecture/testing/taxonomy.md) — the vocabulary this ADR ratifies.
- [ADR-016](./adr-016-linux-vm-test-harness.md) — the "three-tier" harness architecture whose *naming* this supersedes.
