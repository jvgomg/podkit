...
- `docs/architecture/sync/save-transactions.md` — companion architecture doc, updated alongside Phase 4b to reflect engine-owned save coordination for both content types.
