...
- [ADR-001](./adr-001-runtime.md): Runtime choice - FFmpeg works with both Node and Bun
- [ADR-002](./adr-002-libgpod-binding.md): libgpod binding - Transcoding is independent
