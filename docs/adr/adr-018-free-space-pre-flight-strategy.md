...
- `docs/architecture/sync/planning.md` §3 + §6 (current free-space math + degradation note)
- `docs/architecture/sync/save-transactions.md` §3 (pre-sync sweep responsibility)
