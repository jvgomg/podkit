...
**Accepted** — distribution clause refined by [ADR-021](./adr-021-cli-bun-binary-distribution.md).
...
- [ADR-002](./adr-002-libgpod-binding.md): libgpod binding approach (N-API chosen for cross-runtime support)
