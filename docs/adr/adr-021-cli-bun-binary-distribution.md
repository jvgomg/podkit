...
Docs aligned in the same change as this ADR: `packages/docs-site/src/content/docs/developers/building-from-source.md`, `packages/docs-site/src/content/docs/project/roadmap.md`, `docs/agents/releases.md`, `AGENTS.md`, `docs/agents/feature-requests.md`.

## Related Decisions

- [ADR-001](./adr-001-runtime.md) — Runtime Choice (Bun/Node). This ADR refines its distribution clause: libraries Node-compatible, CLI Bun-binary-only.
- [ADR-002](./adr-002-libgpod-binding.md) — N-API bindings stay cross-runtime for the libraries.
