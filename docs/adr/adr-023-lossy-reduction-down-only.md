...
Revises the transfer-mode orthogonality stance of the **PRD: Transfer Mode** (doc-011) and **Spec: Transfer Mode Behavior Matrix** (doc-012); reaffirms the "compatible/device-native lossy → copy as-is" decision of [ADR-010](./adr-010-quality-preset-redesign.md); reshapes the lossy cap-enforcement portion of doc-051 and TASK-437.08. Stands on [ADR-022](./adr-022-sync-tag-sole-quality-truth.md) (the sync tag is the sole quality truth). See the full supersession map below.
...
- [ADR-010](./adr-010-quality-preset-redesign.md) — quality preset redesign (device-aware presets, sync tags).
- [ADR-022](./adr-022-sync-tag-sole-quality-truth.md) — the sync tag is the sole quality truth.
...
- `docs/architecture/sync/upgrades.md` — the quality classifier mechanics this ADR reshapes.
- `docs/principles/transcoding.md`, `docs/principles/transfer-modes.md` — the principle-level statements this ADR instantiates.
