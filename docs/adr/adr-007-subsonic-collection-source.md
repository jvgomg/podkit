...
- [ADR-004](./adr-004-collection-sources.md): Collection Source Abstraction
- [ADR-008](./adr-008-multi-collection-device-config.md): Multi-Collection Configuration

## References

- [Navidrome Subsonic API Compatibility](https://www.navidrome.org/packages/docs-site/src/content/docs/developers/subsonic-api/)
