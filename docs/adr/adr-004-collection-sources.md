...
- Subsonic (API) - see [ADR-007](./adr-007-subsonic-collection-source.md)
...
- [ADR-001](./adr-001-runtime.md): Runtime choice
- [ADR-007](./adr-007-subsonic-collection-source.md): Subsonic adapter implementation
