...
- Maintenance burden
- Compatibility with Bun (see [ADR-001](./adr-001-runtime.md))
...
- [ADR-001](./adr-001-runtime.md): Runtime choice - N-API chosen for compatibility
- [ADR-003](./adr-003-transcoding.md): Transcoding backend - Independent of binding choice
