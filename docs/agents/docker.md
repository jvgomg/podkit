...
podkit is distributed as a Docker image at `ghcr.io/jvgomg/podkit`. See [packages/docs-site/src/content/docs/getting-started/docker.md](../../packages/docs-site/src/content/docs/getting-started/docker.md) for user documentation.
...
the **Integration** depth in the [test taxonomy](../architecture/testing/taxonomy.md)
...
[docs/architecture/device/identity-support-matrix.md](../architecture/device/identity-support-matrix.md).
...
Collections can be configured via environment variables (e.g., `PODKIT_MUSIC_PATH=/music`) — no config file required. See [packages/docs-site/src/content/docs/reference/environment-variables.md](../../packages/docs-site/src/content/docs/reference/environment-variables.md) for details.
...
- Requires `privileged: true` (block-device visibility for detection + mounting; plain `--device /dev/bus/usb` is not sufficient for the daemon — see the passthrough table in packages/docs-site/src/content/docs/getting-started/docker-daemon.md)
- Supports Apprise notifications via `PODKIT_APPRISE_URL`
- File-based health check at `/tmp/podkit-daemon-health`
- See [packages/docs-site/src/content/docs/getting-started/docker-daemon.md](../../packages/docs-site/src/content/docs/getting-started/docker-daemon.md) for user docs
