...
| **Documentation** (`packages/docs-site/src/content/docs/project/roadmap.md`, callouts in other docs) | Communicates what's planned and links to discussions | Users reading the docs |
...
|----------|-------------------|----------------|
| `packages/docs-site/src/content/docs/project/roadmap.md` | All features | Move between Now/Next/Later tiers |
| `packages/docs-site/src/content/docs/project/feedback.md` | General guidance | Rarely changes |
| `packages/docs-site/src/content/docs/user-guide/syncing/music.md` | #2 Podcasts, #3 Audiobooks, #4 Music Videos | Callout at line ~50 |
| `packages/docs-site/src/content/docs/user-guide/syncing/video.md` | #4 Music Videos, #5 Video Podcasts | Callout at line ~42 |
| `packages/docs-site/src/content/docs/user-guide/collections/additional-sources.md` | #35 iTunes/Apple Music, #6 Plex, #7 Jellyfin | Inline links + "Request a Source" section |
| `packages/docs-site/src/content/docs/user-guide/collections/subsonic.md` | #11 Keychain/secret manager | Callout at line ~50 |
| `packages/docs-site/src/content/docs/user-guide/devices/formatting.md` | #10 Device formatting | Caution block at line ~8 |
| `packages/docs-site/src/content/docs/devices/rockbox.md` | #34 Rockbox/non-iTunesDB support | Callout near top of page |
| `packages/docs-site/src/content/docs/getting-started/installation.mdx` | #8 Windows support | Callout at line ~51 |

### Updating the roadmap doc

`packages/docs-site/src/content/docs/project/roadmap.md` has three tiers: **Now**, **Next**, and **Later**. Each feature is a row in a table with a link to its discussion.
...
1. Remove it from `packages/docs-site/src/content/docs/project/roadmap.md`
...
Discussion [#17](https://github.com/jvgomg/podkit/discussions/17) mirrors `packages/docs-site/src/content/docs/project/roadmap.md` in a more concise format. When the roadmap doc changes, update this discussion to match.
...
1. Update `packages/docs-site/src/content/docs/project/roadmap.md` — move the row to the **Next** section
...
1. Update `packages/docs-site/src/content/docs/project/roadmap.md` — move the row to the **Now** section
...
1. Remove from `packages/docs-site/src/content/docs/project/roadmap.md`
...
The roadmap and feedback pages live under `packages/docs-site/src/content/docs/project/` and surface in the Astro sidebar via an autogenerate entry in `packages/docs-site/config/sidebar.ts`:
...
Any new `.md`/`.mdx` file dropped into `packages/docs-site/src/content/docs/project/` is picked up automatically — no sidebar edit needed.
...
3. Add a row to the appropriate tier in `packages/docs-site/src/content/docs/project/roadmap.md`
...
1. Move the row in `packages/docs-site/src/content/docs/project/roadmap.md`
...
2. Remove from `packages/docs-site/src/content/docs/project/roadmap.md`
