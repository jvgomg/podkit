...
[conventions §12](../architecture/conventions.md#12-adding-a-config-field-requires-three-changes-not-one).
...
See [packages/docs-site/src/content/docs/developers/config-migrations.md](../../packages/docs-site/src/content/docs/developers/config-migrations.md) for the full developer guide.
