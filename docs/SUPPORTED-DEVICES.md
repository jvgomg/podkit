...
**Note**: Large capacity iFlash builds (>128GB) may have mounting issues on macOS. See [docs/MACOS-IPOD-MOUNTING.md](MACOS-IPOD-MOUNTING.md) for troubleshooting.
...
See [docs/DEVICE-TESTING.md](DEVICE-TESTING.md) for the full device verification process.
...
2. If missing, create it with your model number:
   ...
   ```
3. See [IPOD-INTERNALS.md](IPOD-INTERNALS.md) for model number reference

### Device Not Mounting

- **macOS**: See [MACOS-IPOD-MOUNTING.md](MACOS-IPOD-MOUNTING.md)
- **Linux**: Ensure you have appropriate udev rules; see libgpod documentation

## References

- [libgpod GitHub](https://github.com/gtkpod/libgpod)
- [gtkpod Wiki](http://www.gtkpod.org/)
- [iPod Database Specification (archived)](https://web.archive.org/web/20110514113255/http://ipl.derpapst.org/wiki/ITunesDB)
- [Rockbox iPod Support](https://www.rockbox.org/wiki/IpodPort)
