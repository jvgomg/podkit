...
|---|---|---|
| **Principles** (this series) | *Why* podkit behaves this way toward your library | `docs/principles/` |
| **ADRs** | *How we decided* to honour a principle, and the alternatives | `docs/adr/` |
| **Architecture** | *How it is wired* in a given subsystem | `docs/architecture/` |
...
- `docs/adr/` — the decision log that implements these promises.
- `docs/architecture/` — the wiring that upholds them.
