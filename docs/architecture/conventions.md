...
|-----------------------|--------------------------------|--------------------------------------------|
| **Architecture docs** | `docs/architecture/`      | Slow-moving settled conventions.           |
| **Doc-NNN journals**  | `backlog/docs/doc-NNN-*.md`    | Living rough-edges + open question logs.   |
| **ADRs**              | `docs/adr/adr-NNN-*.md`             | Frozen-at-decision-time, status evolves.   |
...
See also [docs/agents/config-migrations.md](../agents/config-migrations.md)
