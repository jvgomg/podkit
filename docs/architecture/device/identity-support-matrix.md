...
`docs/architecture/sync/error-handling.md` §6. A blank-but-identified
...
- New transports (e.g. SCSI-in-container) update §4/§5 and
  `packages/docs-site/src/content/docs/getting-started/docker.md`'s onboarding section together.

## 7. References

- `docs/device-identification.md` — m-18 research journal (full sweep data,
  strategy comparison; the empirical basis for §4)
- `docs/test-devices.md` — real-hardware inventory with inquiry results
...
- `docs/adr/adr-020-ipod-identity-structured-fields.md`, `docs/adr/adr-024-device-access-tiers.md`
