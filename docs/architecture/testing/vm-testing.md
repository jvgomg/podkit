...
- [docs/adr/adr-016 — Linux VM test harness](../../adr/adr-016-linux-vm-test-harness.md) — overall split.
- [docs/adr/adr-017 — Device persona fixtures](../../adr/adr-017-device-persona-fixtures.md) — persona registry rationale.
...
- [docs/adr/adr-016 — Linux VM test harness](../../adr/adr-016-linux-vm-test-harness.md) — the original design split.
- [docs/adr/adr-017 — Device persona fixtures](../../adr/adr-017-device-persona-fixtures.md) — persona registry rationale.
