...
Companion reading:
[docs/adr/adr-016 — Linux VM test harness](../../adr/adr-016-linux-vm-test-harness.md)
and
[docs/adr/adr-027 — Lima VM substrate consolidation](../../adr/adr-027-lima-vm-substrate-consolidation.md)
...
- `docs/adr/adr-016-linux-vm-test-harness.md` — overall VM-test split.
