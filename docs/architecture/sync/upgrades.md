...
See [Transfer Modes](../../../docs/principles/transfer-modes.md) and
...
- `docs/adr/adr-023-lossy-reduction-down-only.md` — ADR for the two-axis model
- `docs/adr/adr-022-sync-tag-sole-quality-truth.md` — ADR for the sync-tag-as-truth decision
- `docs/principles/transcoding.md` — seven principles governing the lossy decision
- `docs/principles/transfer-modes.md` — transfer mode as the default for the reduction axis
