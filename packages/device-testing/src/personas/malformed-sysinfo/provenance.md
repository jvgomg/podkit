...
```bash
head -c 500 packages/device-testing/src/personas/ipod-video-5g-iflash-1tb/raw/sysinfo-extended.xml \
  > packages/device-testing/src/personas/malformed-sysinfo/raw/sysinfo-extended.xml
```
...
- Source XML (untruncated): `packages/device-testing/src/personas/ipod-video-5g-iflash-1tb/raw/sysinfo-extended.xml` (9,693 bytes — the first 500 of which are this persona's payload)
