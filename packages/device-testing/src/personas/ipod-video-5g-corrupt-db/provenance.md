...
with open('packages/device-testing/src/personas/ipod-video-5g-corrupt-db/raw/iTunesDB', 'wb') as f:
    f.write(data)
"
```
...
- Sibling real-hardware persona: `packages/device-testing/src/personas/ipod-video-5g-iflash-1tb/`
- SIE XML source (shared): `packages/device-testing/src/personas/ipod-video-5g-iflash-1tb/raw/sysinfo-extended.xml`
...
- Contrast fixture: `packages/device-testing/src/personas/malformed-sysinfo/` (SIE-layer fault)
