 ...
 * the FunctionFS daemon (`tools/device-testing/dummy-hcd/`).
 *
 ...
 *
 * The dummy-hcd daemon (`tools/device-testing/dummy-hcd/`) lives outside
 * `packages/*` and is therefore not a Bun workspace member. To keep the
 * daemon compile-step self-contained, this file imports **nothing** from
 * the rest of `@podkit/device-testing`. The producer-side helpers that
 ...
 * @see tools/device-testing/dummy-hcd/README.md
 * @module
 */
