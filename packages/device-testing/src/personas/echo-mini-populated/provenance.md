...
python3 -c "
import os
raw_dir = 'packages/device-testing/src/personas/echo-mini-populated/raw'
for i in range(1, 6):
...
- Empty-state sibling: `packages/device-testing/src/personas/echo-mini/`
- Shared host-probe payloads: `packages/device-testing/src/personas/echo-mini/raw/`
- Backing-file synthesiser: `packages/device-testing/src/runners/lima-test-vm-backing-files.ts`
- Synthesis script (manual): `packages/device-testing/scripts/build-backing-file.ts`
