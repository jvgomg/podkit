...
describe('libgpod-node artwork (setTrackArtwork)', () => {
  ...
  it('can set artwork for a track from PNG file', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('handles tracks without artwork gracefully', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('can set artwork for multiple tracks', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('throws error for non-existent image file', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('can set artwork on track with copied audio file', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
...
describe('libgpod-node artwork IDs (getUniqueArtworkIds)', () => {
  ...
  it('returns unique artwork IDs when tracks have artwork', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('returns deduplicated artwork IDs', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
...
describe('libgpod-node artwork management APIs', () => {
  ...
  it('hasTrackArtwork returns false for track without artwork', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('hasTrackArtwork returns true for track with artwork', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('removeTrackArtwork removes artwork from track', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('removeTrackArtwork is safe for track without artwork', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('removeTrackArtwork persists after save', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('setTrackArtworkFromData sets artwork from JPEG buffer', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('setTrackArtworkFromData sets artwork from PNG buffer', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('setTrackArtworkFromData persists after save', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('setTrackArtworkFromDataAsync works correctly', async () => {
    await withTestIpod(async (ipod) => {
      const db = await Database.open(ipod.path);
  ...
  it('setTrackArtworkFromData replaces existing artwork', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('getArtworkCapabilities returns capability information', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('getArtworkCapabilities throws when database is closed', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
      db.close();
  ...
  it('full artwork workflow: check, set, verify, remove', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('setTrackArtworkFromData accepts empty buffer without throwing', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('setTrackArtworkFromData accepts arbitrary data without validation', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('artwork operations work with multiple tracks', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
