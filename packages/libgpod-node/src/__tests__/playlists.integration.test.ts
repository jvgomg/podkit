...
describe('libgpod-node playlist CRUD operations', () => {
  it('can create a new playlist', async () => {
  ...
  it('can save and retrieve a created playlist', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('can find playlist by name', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('can find playlist by ID', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('can rename a playlist', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('cannot delete the master playlist', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('can get tracks from a playlist', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('can remove tracks from a playlist', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('playlistContainsTrack returns false for tracks not in playlist', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('can create multiple playlists', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('playlist changes persist after save', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('getMasterPlaylist returns the master playlist', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('tracks added to database are in master playlist', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('throws error when adding track to non-existent playlist', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('can add same track to multiple playlists', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('preserves track order in playlist after save', async () => {
    await withTestIpod(async (ipod) => {
  ...
  it('throws error when removing non-existent playlist', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('throws error when renaming non-existent playlist', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('can create playlist with empty string name', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('can rename playlist to empty string', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('removing track from playlist where track is not present is safe', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
  ...
  it('throws error when getting tracks from non-existent playlist', async () => {
    await withTestIpod(async (ipod) => {
      const db = Database.openSync(ipod.path);
