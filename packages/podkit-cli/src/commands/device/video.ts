/**
 * `podkit device video` — list video content on a connected device.
 */
...
import { type MusicVideoOptions, type DeviceMusicDeps } from './music.js';

export type DeviceVideoDeps = DeviceMusicDeps;

export const videoSubcommand = new Command('video')
